...
def parse_opt():
    ...
    parser.add_argument('--ckpt_dir', type=str, default='./checkpoint/test', help='Directory to save the checkpoint files')
    ...
    parser.add_argument('--loss_mode', type=str, choices=['combine', 'infonce', 'sim'], default='combine', help='Loss function mode')
